...
export default function CcautionForm({ terminal, pos_pos, onCloseModal }) {
  console.log(pos_pos);
            ...
            <main id='input-form'>
              ...
              <div>
                ...
                >
                  ...
                  <option value={pos_pos?.payment_methods?.C_Caution_Deposit}>
                    {pos_pos?.payment_methods?.C_Caution_Deposit}
                  </option>
                </select>
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  onChange={handleAgentChange}
                  disabled={isCreatingAgent}
                  value={agentForm.caution_fee}
                >
                  <option value=''>--Select--</option>
                  {Object.entries(pos_pos?.caution_fee).map((ent) => {
                    console.log(ent);
                    return <option value={Number(ent[0])}>{ent[1]}</option>;
                  })}
                </select>
              </div>
